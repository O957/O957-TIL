# Opening VS Code From The Terminal Via Code

_Today I Learned added on 2025-11-30, learned on 2025-11-30._

For my paid and unpaid programming work I've used [VS Code](https://code.visualstudio.com). The routine for probably 4-5 years has been: I open the target folder by pressing the `Open` button on VS Code's platform or, if I remember to, to `Cmd+O` on my MacOS to open a folder.
...
Of note, to get `code` working, I performed the following actions:

1. Opened VS Code.
2. Open Command Palette via `Cmd+Shift+P`.
3. Typed: "shell command"
4. Selected: "Shell Command: Install 'code' command in PATH"
