---
title: Opening VS Code From The Terminal Via Code
categories: ["vscode", "IDE"]
date: "2025-11-30"
date-modified: "2026-06-14"
---

_Today I Learned added on 2025-11-30, learned on 2025-11-30; edited on 2026-06-14._

For my paid and unpaid programming work I've used [VS Code](https://code.visualstudio.com). The following has been routine for me for roughly 4 years: I open the target folder by pressing the `Open` button on VS Code's platform or, if I remember to, to `Cmd+O` on my MacOS to open a folder.
